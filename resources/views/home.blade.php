  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="{{route('post')}}">POST<i class="bi bi-plus-circle"></i></a></li>
          <li><a href="about.html">ABOUT</a></li>
          <li><a href="contact.html">CONTACT</a></li>
          @if(Auth::check())
          <li class="dropdown"><a href="category.html"><span>{{strtoupper(Auth::user()->username)}}</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
          ...
          @else
          <li class="dropdown"><a href="category.html"><span>ACCOUNT</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
            ...
            <ul class="footer-links footer-blog-entry list-unstyled">
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="/home/assets/img/post-sq-1.jpg" alt="" class="img-fluid me-3">
                  <div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="/home/assets/img/post-sq-2.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="/home/assets/img/post-sq-3.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="/home/assets/img/post-sq-4.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
